...
function CloseWiningHandsPanel()
{
	hands_panel = instance_find(l_obj_hands_panel, 0);
...
{
	score_panel = instance_find(l_obj_score_panel, 0);
	score_panel.OpenPanel();
	
	target_score_panel = instance_find(l_obj_target_score_panel, 0);
	target_score_panel.OpenPanel();
}
function CloseScorePanel()
{
	score_panel = instance_find(l_obj_score_panel, 0);
	score_panel.ClosePanel();
	
	target_score_panel = instance_find(l_obj_target_score_panel, 0);
	target_score_panel.ClosePanel();
}